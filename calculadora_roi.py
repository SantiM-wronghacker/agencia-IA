...
def main():
    ...
    roi_anual = calculadora.calcular_roi()
    flujo_caja_mensual = calculadora.calcular_flujo_caja_mensual()
    tiempo_recuperacion = calculadora.calcular_tiempo_recuperacion()

    print(f"\nResultados:")
    print(f"ROI anual: {roi_anual:.2f}%")
    print(f"Flujo de caja mensual: ${flujo_caja_mensual:.2f}")
    print(f"Tiempo de recuperación: {tiempo_recuperacion:.2f} meses")

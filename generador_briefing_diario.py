...
def main():
    try:
        ...
        print(f'La temperatura en México es de {temperatura_mexico}°C y la humedad es de {humedad_mexico}%.')
        print(f'El tipo de cambio es de {tipo_cambio} MXN/USD.')
        print(f'El índice de inflación es de {indice_inflacion}% y la tasa de desempleo es de {tasa_desempleo}%.')

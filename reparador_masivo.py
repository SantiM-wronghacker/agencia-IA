...
IMPORTS_PROHIBIDOS = {"ollama", "openai", "langchain", "lm_studio", "lm-studio", "google.generativeai"}
    ...
    for p in problemas:
        if p.startswith("IMPORT_PROHIBIDO:"):
            ...
            instrucciones.append(
                ...
                f"from groq import Groq / client = Groq(api_key='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') "

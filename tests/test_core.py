...
def test_save_and_load_state(tmp_path):
    from core import save_state, load_state
...
def test_format_recent():
    from core import format_recent
    state = {"recent": [
...
def test_build_context_prefix_empty():
    from core import build_context_prefix

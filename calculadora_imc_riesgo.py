...
def main():
    try:
        ...
        print("Recomendación: Consulta a un profesional de la salud")
        print("Resumen ejecutivo:")
        print(f"El IMC de {peso} kg y {altura} m es {imc:.2f}, lo que indica {riesgo}.")
        print(f"El porcentaje de grasa corporal es {porcentaje_grasa:.2f}% y las calorías en reposo son {calorias_en_reposo:.2f} kcal.")
